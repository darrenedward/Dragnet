...
function ScanTokensSection({ repoId }: { repoId: string }) {
  const [tokens, setTokens] = useState<Array<{ id: string; label: string; prefix: string; createdAt: string; revoked: boolean }>>([]);
